...
import {getChromeMajorVersion} from '@mk-compress/electron-versions';
...
function handleHotReload() {
  ...
  return {
    name: '@mk-compress/preload-process-hot-reload',
    ...
    config(config, env) {
      ...
      const rendererWatchServerProvider = config.plugins.find(p => p.name === '@mk-compress/renderer-watch-server-provider');
